...
class ExplainS4 extends Field
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $message = 'Settle Transaction must be delivered to CembraPay manually or from ERP system';
        $color = 'FFE5E6';
        if ($cembrapaycheckout_s4_explain == 1) {
            $message = 'Settle Transaction will be sent to CembraPay when new Invoice is created on the order';
            $color = 'ddffdf';
        }
